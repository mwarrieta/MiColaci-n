    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-heading font-bold text-gray-900">Gestión de Menú</h1>
                    <p className="text-gray-500 mt-1">Administra los platos disponibles, precios y categorías.</p>
                </div>
